  ...
  async function decide(id,ok,note,quiet){
    ...
    if(q.kind==="group"&&ok){
      ...
      if(q.ownerUid){
        ...
        notifyApproval(q.ownerUid,"রক্তের গ্রুপ পরিবর্তন অনুমোদিত",
    ...
    if(!ok){
      ...
      if(q.kind==="donor"&&owner)notifyRejection(owner,"ডোনার আবেদন বাতিল",
        "আপনার রক্তদাতা আবেদনটি বাতিল করা হয়েছে"+why+".",q.memberId||q.id||owner,"req:become");
      if(q.kind==="request"&&owner){
        notifyRejection(owner,"জরুরি রক্তের আবেদন বাতিল",
          "আপনার জরুরি রক্তের আবেদনটি বাতিল করা হয়েছে"+why+".",q.id||owner,"req:mine");
        markRequestRejected(owner,q.id,note);
      }
      if(q.kind==="group"&&owner)notifyRejection(owner,"রক্তের গ্রুপ পরিবর্তন বাতিল",
        "রক্তের গ্রুপ পরিবর্তনের অনুরোধটি বাতিল করা হয়েছে"+why+".",q.id||owner,"set:donor");
      if(q.kind==="donation"&&owner)notifyRejection(owner,"রক্তদানের রেকর্ড বাতিল",
        "আপনার রক্তদানের রেকর্ডটি বাতিল করা হয়েছে"+why+".",q.id||owner,"set:adddonation");
    }
    DB.queue.splice(i,1);
