...
/**
 * Admin.tsx
 * React + TypeScript port of admin.html — অ্যাডমিন প্যানেল (super)।
 */
...
function initPage() {
  ...
  const defaultMe=()=>({
    ...
    prefs:{theme:"system",lang:"bn",dense:false,anim:true,badge:true,startPage:"home"},
    sessions:[],
    activity:[]
  });
  function loadMe(){
  ...
  matchMedia("(prefers-color-scheme:dark)").addEventListener("change",()=>{
    if(ME.prefs.theme==="system")applyPrefs()});
...
export default function Admin() {
  useEffect(() => {
    document.body.dataset.panel = "super";
    initPage();
  }, []);
