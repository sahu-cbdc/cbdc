 ...
 *
 *   POST /api/account/profile     — upsert users/{caller.uid} (server merge)
 *   POST /api/account/claim-email — identityIndex/email claim (CAS semantics)
 *   POST /api/account/claim-login — loginIndex username/phone claims
 *
